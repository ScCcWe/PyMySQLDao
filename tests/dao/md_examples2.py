...
if __name__ == '__main__':
    ...
    # select by field
    # print(dao.select_by_field("", field_key="class_name"))
    ...
    print(dao.select_by_field(field_value="骏马班", field_key="class_name", limit_size=5))
    # print(dao.select_by_field("骏马班", field_key="class_name", limit_size=10))
